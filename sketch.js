...
function setup(){
    ...
    particle7 =Bodies.circle(240,10,12,particle_options);
...
function draw(){
  ...
  ellipse(particle1.position.x,particle1.position.y,11);
  ellipse(particle2.position.x,particle2.position.y,12);
  ellipse(particle3.position.x,particle3.position.y,13);
  ellipse(particle4.position.x,particle4.position.y,14);
  ellipse(particle5.position.x,particle5.position.y,15);
  ellipse(particle6.position.x,particle6.position.y,16);
  ellipse(particle7.position.x,particle7.position.y,17);
